    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          res = _context3.sent;
          if (res.data.message === "success") {
            (0, _alert.showAlert)(res.data.message, "Account Created!");
            window.location.assign('/');
          }
          _context3.next = 12;
          break;
...
exports.updateUser = exports.updatePassword = exports.resetPassword = exports.forgetPassword = void 0;
var _alert = require("./alert");
...
var forgetPassword = exports.forgetPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          res = _context2.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)('success', "Reset Link Sent to Email!");
            setTimeout(function () {
  ...
  return function forgetPassword(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(passData, token) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "PATCH",
            url: "/api/user/resetpassword/".concat(token),
            data: _objectSpread({}, passData)
          });
        case 4:
          res = _context3.sent;
          if (res.data.status === "success") {
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(curP, Pass, cPass) {
    var res, newData;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
...
if (updateForm) {
  updateForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var form, email, name, photo, phone;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return bookTour(e.target.dataset.tourId);
          case 3:
